    ...
    <section className="relative py-32 px-6 overflow-hidden bg-background" id="pricingsection">
      ...
      <div className="absolute inset-0 -z-10">
        <motion.div 
          ...
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-125 w-125 rounded-full bg-primary/20 blur-[120px]" 
        />
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        >
          ...
          <div className="relative bg-card/40 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-8 md:p-16 shadow-2xl overflow-hidden">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              {/* Right: The Hook & CTA */}
              <div className="relative flex flex-col items-center justify-center p-8 rounded-[2.5rem] bg-linear-to-b from-primary/5 to-transparent border border-primary/10">
                <div className="text-center mb-8">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <div className="flex items-baseline gap-1">
                      <span className="text-7xl font-black tracking-tight text-foreground">{PRICING.MONTHLY_PRICE}</span>
                      <span className="text-muted-foreground text-xl font-medium">/mo</span>
                    </div>
                  </div>
                ...
                <SignUpButton mode="modal">
                  <Button 
                    className="group relative w-full h-14 px-8 overflow-hidden rounded-2xl bg-primary text-primary-foreground font-bold text-lg shadow-lg transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
                  >
                    <span className="absolute inset-0 w-full h-full bg-linear-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:animate-[shimmer_2s_infinite]" />
                ...
                <p className="mt-6 text-[10px] uppercase tracking-widest text-muted-foreground/60 text-center font-medium">
        ...
        <div className="mt-16 flex flex-wrap justify-center gap-10 opacity-40 grayscale hover:grayscale-0 transition-all duration-500">
             <div className="flex items-center gap-2 text-xs font-bold tracking-widest uppercase"><CheckCircle2 className="h-4 w-4 text-primary" /> SECURE STRIPE CHECKOUT</div>
             <div className="flex items-center gap-2 text-xs font-bold tracking-widest uppercase"><CheckCircle2 className="h-4 w-4 text-primary" /> NO UPFRONT PAYMENT</div>
             <div className="flex items-center gap-2 text-xs font-bold tracking-widest uppercase"><CheckCircle2 className="h-4 w-4 text-primary" /> CANCEL ANYTIME</div>
        </div>
      </div>
