...
import { CalendarDays, GraduationCap, BookOpen, ArrowRight, Inbox } from "lucide-react";
...
export default function TodayBox() {
  ...
  return (
    ...
    >
      ...
      {/* --- RIGHT: STUDY TASKS PLACEHOLDER --- */}
      <div className="md:col-span-7 p-8 bg-background/20">
